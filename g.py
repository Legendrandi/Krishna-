...
TOKEN = '6926228917:AAGwAw8f8rpqLxqx-o3MgGulEIH5f3mWxPs'
MONGO_URI = 'mongodb+srv://Bishal:Bishal@bishal.dffybpx.mongodb.net/?retryWrites=true&w=majority&appName=Bishal'
FORWARD_CHANNEL_ID = -1002188499770
CHANNEL_ID = -1002188499770
error_channel_id = -1002188499770
...
def send_not_approved_message(chat_id):
    bot.send_message(chat_id, "*YOU ARE NOT APPROVED BUY ACCESS:-@Pro_lege9d*", parse_mode='Markdown')
...
def handle_message(message):
    ...
    if message.text == "Instant Plan 🧡":
        ...
        bot.send_message(message.chat.id, "*FOR RESELLERSHIP DM:-@Pro_lege9d*", parse_mode='Markdown')
